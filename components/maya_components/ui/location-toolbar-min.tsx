...
interface LocationToolbarMinProps {
...
const LocationToolbarMin = React.forwardRef<
  HTMLDivElement,
  LocationToolbarMinProps
>(({
  time,
  date,
  formatTime,
...
LocationToolbarMin.displayName = "LocationToolbarMin"

export { LocationToolbarMin }
