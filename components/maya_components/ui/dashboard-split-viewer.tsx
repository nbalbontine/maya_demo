...
export default function DashboardSplitViewer() {
  ...
  return (
    <div className="dashboard-viewer-container relative w-full h-full flex-1">
      {isLoading && (
        <div className="absolute inset-0 flex items-center justify-center bg-background/80 backdrop-blur-sm z-50">
          <div className="text-muted-foreground">Loading 360° images...</div>
        </div>
      )}
      ...
      >
        ...
        <div 
          ...
          className={viewMode === 'single' 
            ? "dashboard-viewer-single dashboard-viewer-left absolute inset-0" 
            : "dashboard-viewer-split dashboard-viewer-left absolute top-0 left-0 h-full"
          }
        >
          <Viewer360 
            ref={viewer1Ref}
        ...
        <div 
          ...
          className={viewMode === 'single' 
            ? "dashboard-viewer-split dashboard-viewer-right hidden" 
            : "dashboard-viewer-split dashboard-viewer-right absolute top-0 h-full"
          }
        >
          <Viewer360 
            ref={viewer2Ref}
        ...
        {viewMode === 'split' && (
          <div 
            ref={splitLineRef}
            className="dashboard-split-line absolute top-0 h-full w-1 bg-border cursor-ew-resize z-[999] transform -translate-x-0.5"
            onMouseDown={handleSplitMouseDown}
          >
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-5 h-5 bg-background border-2 border-border rounded-full shadow-sm flex items-center justify-center">
              <button
        ...
        <div 
          className="absolute top-0 left-0 z-[1002]"
          style={{ 
        ...
        {viewMode === 'split' && (
          <div 
            className="absolute top-0 z-[1002]"
            style={{ 
